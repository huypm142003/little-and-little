          ...
          <Row gutter={28} className="mt-[42px]">
            <Col span={15} className="ml-[53px]">
              <Card className="card rounded-3xl z-[2] bg-[#fde8b3] border-0 border-b-[#ffca7b] border-b-[12px]">
                <div className="border-[#FFB489] rounded-3xl bg-[#fff6d4] border-[4px] border-dashed p-[25px]">
                  <Form>
                    <Row className="mb-7">
                      <Col>
            ...
            <Col span={8} className="flex flex-col justify-between">
              <Card className="card rounded-3xl z-[2] bg-[#fde8b3] border-0 border-b-[#ffca7b] border-b-[12px]">
                <div className="border-[#FFB489] rounded-3xl bg-[#fff6d4] border-[4px] border-dashed px-3 py-5 flex items-center">
              ...
              <Card className="card rounded-3xl z-[2] bg-[#fde8b3] border-0 border-b-[#ffca7b] border-b-[12px]">
                <div className="border-[#FFB489] rounded-3xl bg-[#fff6d4] border-[4px] border-dashed px-3 py-9 flex items-center">
                  <img src={Email} alt="Address" className="mr-4" />
                  <div className="flex flex-col">
                    <h3 className="text-[#12265a] montserrat text-[22px] font-semibold">
                      Email:
                    </h3>
              ...
              <Card className="card rounded-3xl z-[2] bg-[#fde8b3] border-0 border-b-[#ffca7b] border-b-[12px]">
                <div className="border-[#FFB489] rounded-3xl bg-[#fff6d4] border-[4px] border-dashed px-3 py-9 flex items-center">
                  <img src={Telephone} alt="Address" className="mr-4" />
                  <div className="flex flex-col">
                    <h3 className="text-[#12265a] montserrat text-[22px] font-semibold">
                      Điện thoại
                    </h3>
